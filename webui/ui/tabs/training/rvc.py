        ...
        with gradio.Column(visible=False) as settings:
            ...
            with gradio.Tabs():
                with gradio.Tab('data'):
                    ...
                    f0_method = gradio.Radio(["dio", "pm", "harvest", "torchcrepe", "torchcrepe tiny"], value='harvest', label='Pitch extraction method', info='Harvest is usually good, crepe has potential to be even better.')
